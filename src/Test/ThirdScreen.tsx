  ...
  const CTAButtons = () => (
    <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 lg:gap-10 mt-6 w-full">
      <Button
        ...
        className="bg-white border-2 hover:bg-transparent hover:scale-105 active:scale-95 transition-all duration-300 ease-out z-10 w-full sm:w-auto transform hover:-translate-y-1"
      >
        <span className='text-[#750015] hover:text-white text-sm sm:text-base transition-colors duration-300'>Sign up now</span>
      </Button>
      <Button
        onClick={handleLogin}
      ...
      >
        Log In 
        <svg className='hover:stroke-[#750015]' width="24" height="24" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2.48438 6.125L9.00506 6.12199" stroke="#ffff" stroke-width="0.698645" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M5.72656 2.86328L8.98841 6.12212L5.72957 9.38396" stroke="#ffff" stroke-width="0.698645" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
  ...
  return (
    <div className="bg-[#750015] min-h-screen w-full font-archivo overflow-hidden text-white">
      ...
      >
        ...
        <div className="lg:w-1/2 flex justify-center items-center mt-8 lg:mt-0 animate-float-slow">
          <img 
            src={mockups} 
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 justify-center items-center mt-8 lg:mt-12 overflow-hidden">
          <div className="w-full max-w-lg lg:max-w-none h-auto lg:h-[600px] xl:h-[768px] flex flex-col justify-between items-center rounded-3xl lg:rounded-[60px] border-4 relative bg-[#750015]/30 p-6 lg:p-0 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
            ...
            <div className="w-full flex justify-center items-end mt-8 lg:mt-0 lg:absolute lg:bottom-0 lg:left-0 animate-fade-in-up delay-300">
              <div className="relative w-[420px] h-[260px] flex justify-center ">
                <img
                  src={featureMockup1}
                  alt="Feature mockup 1"
                  className="w-[420px] h-auto rounded-2xl shadow-lg z-10"
                  style={{ position: 'absolute', left: '-70px', bottom: 0 }}
                />
                <img
                  src={featureMockup2}
                  alt="Feature mockup 2"
                  className="w-[420px] h-auto rounded-2xl shadow-xl z-20"
                  style={{ position: 'absolute', left: '70px', bottom: 0 }}
                />
              </div>
            </div>
          ...
          <div className="w-full max-w-lg lg:max-w-none h-auto lg:h-[600px] xl:h-[768px] flex flex-col justify-between items-center rounded-3xl lg:rounded-[60px] border-4 relative bg-white p-6 lg:p-0 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl delay-200">
            ...
            <div className="w-full flex justify-center items-end mt-8 lg:mt-0 lg:absolute lg:bottom-0 lg:left-0 animate-fade-in-up delay-400">
              <div className="relative w-full max-w-xs lg:max-w-[420px] h-48 lg:h-[260px] flex justify-center">
                <img
                  src={featureMockup3}
                  alt="Feature mockup 3"
                  className="w-full max-w-xs lg:max-w-[420px] h-auto rounded-2xl shadow-lg z-10 transform transition-all duration-500 hover:-translate-y-2"
      ...
      >
        <div className="bg-[#FF6682] pink-bg flex flex-col lg:flex-row justify-between p-6 sm:p-8 lg:px-12 gap-6 lg:gap-8 pt-4 rounded-3xl lg:rounded-[45px] relative overflow-hidden transform transition-all duration-500 hover:shadow-2xl">
          ...
          <div className="flex justify-center items-center mt-6 lg:mt-10 z-10 w-full lg:w-1/2 animate-fade-in-up delay-300">
            <div className='relative w-full flex justify-center items-center'>
              <img 
                src={engageMockup} 
                alt="App mockup" 
                className="w-1/2 sm:w-2/5 lg:w-1/2 max-w-xs animate-float transform transition-all duration-500 hover:scale-105" 
              />
              <div className="absolute pointer-events-none bottom-10 lg:bottom-20 left-2 lg:left-10 scale-75 lg:scale-100">
                ...
                <img 
                  src={popup2} 
                  alt="Popup 2" 
                  className="animate-bounce-slow delay-300" 
                />
              </div>
            </div>
          </div>
