            ...
            <div className="mt-[38px] flex flex-1 items-center justify-center gap-[45px] md:flex-col md: self-stretch"> 
                <div className="w-[56%] md:w-full">
                    ...
                    <div className="rounded-[24px] bg-[#ffffff] p-5">
                        <div className="mt-2.5 flex flex-col gap-6">
                            ...
                            <div className="flex flex-1 items-start self-center sm:self-stretch">
                                <div className="flex w-[72%] items-center gap-4 self-center">
                                <div className="w-[20%] rounded-[32px] bg-[#e6e6e699] px-1 py-2">
                                    <Img
                                    src="images/img_unilag_logo_1.png"
                                    alt="Unilaglogoone"
                                    className="h-[48px] w-full object-cover md:h-auto"
                                    />
                                </div>
                                <div className="flex flex-1 flex-col items-start justify-center">
                                    <Text as="p" className="text-[28px] font-medium md:text-[26px] sm:text-[24px]">
                                    University of Lagos
                                    </Text>
                                ...
                                alt="Materialsymbol"
                                className="mt-2.5 h-[24px] w-[24px]"
                                />
                            </div>
                            <Img
                        ...
                        <Text
                            ...
                            as="p"
                            className="mt-3.5 text-[20px] font-normal leading-[30px]"
                        >
                            The University management has decided to improve and renovate its hostels,
                            ensuring comfortability of all students. The University has decided to
                            improve and renovate its hostels, ensuring comfortability of all students.
                        </Text>

                        <div className="mx-2 mt-[34px] h-[170px] rounded-[10px] bg-[#d9d9d9] md:mx-0" />
                        <div className="mr-4 mt-3.5 h-px bg-[#d9d9d9] md:mr-0" />

                        <div className="ml-5 mr-9 mt-3.5 flex justify-center md:mx-0">
                            <div className="flex items-center">
                            <Img
                                src="images/img_material_symbol_pink_900.svg"
                                alt="Materialsymbol"
                                className="h-[32px] w-[32px]"
                            />
                            <Text as="p" className="text-[14px] font-normal ml-1">14.6K</Text>
                            </div>

                            <div className="flex items-center gap-1 px-[34px] sm:px-5">
                            <img
                                src="images/img_search_pink_900.svg"
                                alt="Search"
                                className="h-[32px] w-[32px]"
                            />
                            ...
                            <div className="flex flex-1 items-center px-[34px] sm:px-5">
                            <Img
                                src="images/img_zondicons_repost.svg"
                                alt="Zondicons"
                                className="h-[32px] w-[32px]"
                            />
                            <Text as="p" className="text-[14px] font-normal ml-1">3K</Text>
                            </div>

                            <Img
                            src="images/img_mynaui_share.svg"
                            alt="Mynauishare"
                            className="h-[32px] w-[32px]"
                            />
                        </div>
                ...
                <div className="flex flex-col items-start rounded-[32px] border border-solid border-[#bebebe] px-[22px] py-5 sm:px-5">
                    ...
                    <div className="mb-[18px] mr-2 mt-3 flex flex-col gap-5 self-stretch py-2.5 md:mr-0">
                        <Suspense fallback={<div>Loading feed...</div>}>
                            {data.map((d, index) => (
                                <Common5 {...d} key={"listfollow" + index} />
                            ))}
                        </Suspense>
                    </div>
                </div>
