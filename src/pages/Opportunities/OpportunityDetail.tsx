  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-col w-full gap-8">
              <div className="flex flex-col">
                    {/* Header Section */}
              <div className="flex flex-row lg:items-center lg:justify-between mb-8 gap-4">
        ...
        <div className="flex justify-center items-center">
          <Button
            className="bg-[#750015] text-white w-[85%] py-3 rounded-lg font-semibold hover:bg-[#5a0010] shadow-lg flex items-center justify-center gap-2"
            onClick={handleApply}
          >
            {hasApplicationLink ? (
              <>
