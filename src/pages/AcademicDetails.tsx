  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[599px] mx-auto mt-12 p-12 bg-[#E6E6E699] rounded-t-[20px]">
        ...
        <p className="text-base text-[#4D4D4D] mb-[75px]">
          Provide your faculty, and department to set up your profile.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            >
              <span className="text-base">{selectedDepartment || 'Department'}</span>
              <ChevronDown className="w-5 h-5" />
            </button>
          </div>
