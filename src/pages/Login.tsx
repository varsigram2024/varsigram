    ...
    <div className="min-h-screen bg-white flex font-['Archivo']">
      ...
      <div className="w-[740px] p-8 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          <h2 className="text-4xl font-semibold text-center leading-[52px]">
            Get instant access to <span className="text-[#750015]">communication</span>
      ...
      <div className="flex-1 bg-[#E6E6E699] p-12">
        <div className="max-w-[496px] mx-auto mt-12">
          <h1 className="text-[45px] font-semibold mb-8 animate-fade-in">Log In</h1>
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center gap-4 animate-slide-up" style={{ animationDelay: '400ms' }}>
            ...
            <p className="text-center animate-slide-up" style={{ animationDelay: '600ms' }}>
