    ...
    >
      <div className="flex h-full flex-col px-0 items-center">
        ...
        <div 
          ...
          className="mt-[45px] flex self-stretch gap-5 px-5 py-4 items-center cursor-pointer hover:bg-gray-50"
        >
        ...
        >
          ...
          {!collapsed && (
            <Heading as="p" className={currentPage === 'connections' ? 'text-[#750015]' : 'text-gray-600'}>
              Connections
            </Heading>
          )}
        </div>
        ...
        >
          ...
          {!collapsed && (
            <Heading as="p" className={currentPage === 'chat' ? 'text-[#750015]' : 'text-gray-600'}>
              Chats
            </Heading>
          )}
        </div>
        ...
        >
          ...
          {!collapsed && (
            <Heading as="p" className={currentPage === 'resources' ? 'text-[#750015]' : 'text-gray-600'}>
              Resources
            </Heading>
          )}
        </div>
        ...
        >
          ...
          {!collapsed && (
            <Heading as="p" className={currentPage === 'marketplace' ? 'text-[#750015]' : 'text-gray-600'}>
              Marketplace
            </Heading>
          )}
        </div>
