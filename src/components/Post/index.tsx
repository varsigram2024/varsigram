      ...
      className="flex w-full flex-col items-center p-5 mb-6 rounded-xl bg-[#ffffff]">
        <div className="flex flex-col gap-7 self-stretch">
          ...
          <div className="flex justify-between items-center border-t pt-4">
            ...
            {/* View count */}
            <div className="flex items-center gap-2">
              <svg width="22" height="21" viewBox="0 0 32 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="relative"
              ...
              <svg width="22" height="21" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
