// CLEANED AND FIXED: components/Common3.tsx
...
export default function Common3({
  className = "",
  universityof,
  duration,
  universityof1,
  ...
  return (
    ...
    >
      <div className="ml-2 flex flex-col gap-6 self-stretch sm:ml-0 sm:gap-6">
        <div className="flex items-start">
          <div className="flex flex-1 items-start self-center">
            <div className="flex w-[56%] items-center gap-4 self-center">
              <div className="flex flex-col items-center rounded-[32px] bg-[#e6e6e699] p-2">
                {!!universityof && (
                  <img src={universityof} alt="University logo" className="h-[48px] w-[48px] object-cover" />
                )}
              </div>
          ...
          {!!universityof2 && <Img src={universityof2} alt="University avatar" className="h-[36px] w-[36px]" />}
        </div>
      ...
      <Text
        ...
        as="p"
        className="mt-7 w-full text-[20px] font-normal leading-[30px] sm:text-[17px]"
      >
      ...
      <div className="my-3.5 ml-6 mr-4 flex justify-center self-stretch sm:mx-0">
        ...
        {!!p146kthree && <Img src={p146kthree} alt="146k more" className="h-[32px] w-[32px]" />}
      </div>
    </div>
  );
}
